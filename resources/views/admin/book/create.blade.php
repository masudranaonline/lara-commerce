            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" name="author_id" id="author_id">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="is_ebook" name="is_ebook">
                    </div>
