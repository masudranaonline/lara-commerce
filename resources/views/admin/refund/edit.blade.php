...
@section('content')
    ...
    <main id="main" class="main">
        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
                <label for="inputName5" class="form-label">Returned  Price</label>
                <input type="text" class="form-control" >
            </div>
            <div class="row">
            ...
            <div class="col-md-6">
            <label for="inputEmail5" class="form-label">Mobile No</label>
                <input type="text" class="form-control" id="inputEmail5">
            </div>
            <div class="col-md-6">
                <label for="inputEmail5" class="form-label">Refund fact</label>
                <input type="text" class="form-control" id="inputEmail5">
                </div>
                <div class="col-md-6">
                <label for="inputPassword5" class="form-label">Return Date</label>
                <input type="text" class="form-control" id="inputPassword5">
                </div>

                <div class="col-md-6">
                <label for="inputEmail5" class="form-label">Vendor Name</label>
                    <input type="text" class="form-control" id="inputEmail5">
                </div>
                <div class="col-md-6">
                    <label for="inputPassword5" class="form-label">Company Name</label>
                    <input type="text" class="form-control" id="inputPassword5">
                </div>
                <div class="col-md-6">
